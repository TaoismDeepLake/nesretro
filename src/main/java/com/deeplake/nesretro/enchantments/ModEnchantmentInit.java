package com.deeplake.nesretro.enchantments;
...
public class ModEnchantmentInit {
    ...
    //Example Enchant
//    public static final ModEnchantmentBase ANTI_VANILLA = new ModEnchantmentBase("nesretro.anti_vanilla", Enchantment.Rarity.UNCOMMON, EnumEnchantmentType.WEAPON,  mainHand)
