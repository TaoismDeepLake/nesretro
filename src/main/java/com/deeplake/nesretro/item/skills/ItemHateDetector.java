...
import static com.deeplake.nesretro.util.NBTStrDef.IDLNBTDef.STATE;
import static com.deeplake.nesretro.util.NBTStrDef.IDLNBTUtil.GetInt;
import static com.deeplake.nesretro.util.NBTStrDef.IDLNBTUtil.SetInt;

public class ItemHateDetector extends ItemSkillBase {

    private Class<? extends EntityLiving> targetCategory = EntityLiving.class;
    private String msgKey = "nesretro.msg.being_targeted";
