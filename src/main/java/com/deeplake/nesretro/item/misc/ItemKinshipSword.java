package com.deeplake.nesretro.item.misc;

import com.deeplake.nesretro.item.IGuaEnhance;
import com.deeplake.nesretro.item.ItemSwordBase;
import com.deeplake.nesretro.util.IDLGeneral;
...
import static com.deeplake.nesretro.util.IDLSkillNBT.GetGuaEnhance;
...
//    public com.deeplake.nesretro.item.skills.martial.BuffTuple GetWaterBuff(ItemStack stack)
//    {
//        int water = GetGuaEnhance(stack, 2);
//        return new com.deeplake.nesretro.item.skills.martial.BuffTuple(water / 4, TICK_PER_SECOND * water * 2);
//    }
//
//    public com.deeplake.nesretro.item.skills.martial.BuffTuple GetMountainBuff(ItemStack stack)
//    {
//        int gua = GetGuaEnhance(stack, 4);
//        return new com.deeplake.nesretro.item.skills.martial.BuffTuple(gua / 4, TICK_PER_SECOND * gua * 2);
//    }
//
