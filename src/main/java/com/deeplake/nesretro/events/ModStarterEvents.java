package com.deeplake.nesretro.events;
...
import static com.deeplake.nesretro.util.IDLNBT.*;
...
//				  CommonFunctions.SendMsgToPlayerStyled((EntityPlayerMP)player, "nesretro.msg.starter_kit_given", TextFormatting.AQUA);
//			  }
