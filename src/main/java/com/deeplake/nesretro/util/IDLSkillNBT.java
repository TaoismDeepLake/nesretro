...
import com.deeplake.nesretro.item.skills.ItemSkillBase;
import com.deeplake.nesretro.util.NBTStrDef.IDLNBTDef;
...
import static com.deeplake.nesretro.util.CommonDef.INT_AS_FLOAT;
import static com.deeplake.nesretro.util.NBTStrDef.IDLNBTDef.*;
import static com.deeplake.nesretro.util.NBTStrDef.IDLNBTUtil.*;
    ...
    public static void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag,
        ...
        if (shiftPressed)
        {
            ...
            if (showGuaSocketDesc)
            {
                ...
                if (guaTotal > 0)
                {
                    tooltip.add(I18n.format("nesretro.gua_enhance_list.desc", GetGuaEnhanceString(stack, 0),
            ...
            tooltip.add(TextFormatting.AQUA +  I18n.format("nesretro.shared.press_shift"));
            if (use_flavor)
            {
