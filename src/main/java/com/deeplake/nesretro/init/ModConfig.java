...
public class ModConfig {
    ...
    @Config.LangKey("configgui.nesretro.category.Menu0.GeneralConf")
...
//        @Config.LangKey("nesretro.conf.general.welcome")
//        @Config.Comment("The text shown when a player logs in. Can be a key or a string.")
//        public String WELCOME_MSG = "nesretro.msg.welcome";
    }

    @Config.LangKey("configgui.nesretro.category.Menu0.DebugConf")
    ...
    @Config.LangKey("configgui.nesretro.category.Menu0.SpawnConf")
